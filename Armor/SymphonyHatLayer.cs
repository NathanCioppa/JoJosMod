...
namespace JoJosMod.Armor
{
    internal class SymphonyHatLayer : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            DrawData drawData = new(hatTexture.Value, position ,null, Lighting.GetColor(drawInfo.drawPlayer.position.ToTileCoordinates()), 0, drawInfo.rotationOrigin ,1f,drawInfo.drawPlayer.direction > 0 ? SpriteEffects.None : SpriteEffects.FlipHorizontally);
